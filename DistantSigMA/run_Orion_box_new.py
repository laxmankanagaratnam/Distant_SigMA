...
for chunk in np.unique(chunk_labels)[:]:
    if chunk != 2:
        ...
        # sfs, means = random_sampling(
        #     "/Users/alena/PycharmProjects/SigMA_Orion/Data/Scale_factors/" + f"sfs_region_{chunk}.txt", 50)

        sfs, means = lhc_lloyd('../Data/Scale_factors/' + f'sfs_region_{chunk}.txt', 100)
